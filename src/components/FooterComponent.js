            ...
            <div className="container">
                <div className="row justify-content-center">
                    ...
                    <div className="col-7 col-sm-5">
                        <h5>Our Address</h5>
                        <address>
                            121, abc Road, Karachi<br />
                            Sindh<br/>
                            Pakistan<br/>
                            <i className="fa fa-phone fa-lg"></i>: +92312 1234567<br/>
                            <i className="fa fa-fax fa-lg"></i>: +92312 1234567<br/>
                            <i className="fa fa-envelope fa-lg"></i>: <a href="mailto:shahzebkalm456@gmail.com">shahzebkalam456@gmail.com</a><br/>                            
                        </address>
                    </div>
                    <div className="col-12 col-sm-4 align-self-center">
                        <div className="text-center">
                            ...
                            <a className="btn btn-social-icon btn-youtube" href="https://youtube.com/+"><i className="fa fa-youtybe"></i></a>
                ...
                <div className="row justify-content-center">
                    <div className="col-auto">
                        <p>© Copyright 2020 SRK. Collection</p>
                    </div>
                </div>
